...
return <div>
   ...
   <InventoryCard imgURL={inventory.inventoryImageUri!} CollectionName={inventory.inventoryName} CollectionWebsite={inventory.inventoryWebsiteUri!} Collectionid={inventory.id}/>
</div>;
})}
</div>
  )
